...
import { supabase } from '../../../lib/supabase'; // Sesuaikan path ini dengan folder lib Anda

export default function AdminLogin() {
  const router = useRouter();
  const [email, setEmail] = useState(''); // Mengganti username menjadi email sesuai standar Auth
  ...
  const handleLogin = async (e) => {
    ...
    try {
      // PROSES LOGIN DINAMIS KE SUPABASE
      ...
      router.refresh(); // Segarkan route agar middleware mendeteksi sesi baru
